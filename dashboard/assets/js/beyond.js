...
if (location.pathname != "/index-rtl-fa.html" && location.pathname != "http://s3.amazonaws.com/index-rtl-ar.html") {
    ...
    $("#sidebar-collapse").on('click', function () {
        ...
        if (b) {
            ...
            if ($('.page-sidebar').hasClass('sidebar-fixed')) {
                var position = (readCookie("rtl-support") || location.pathname == "/index-rtl-fa.html" || location.pathname == "http://s3.amazonaws.com/index-rtl-ar.html") ? 'right' : 'left';
